...
> _tip_: this frontend is designed to work with [Flask-based Backend](../backend). It is recommended you set up the backend first, test using Postman, and then the frontend should integrate smoothly.
